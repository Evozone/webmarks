...
<main class="min-h-screen grid place-items-center">
    ...
    <div class="grid grid-cols-2 gap-8 p-16 w-full min-h-screen">
        ...
        <h2 class="text-4xl font-bold text-center grid place-items-center text-white">
        ...
        <h1 class="text-6xl font-bold text-center grid place-items-center text-white">WebMarks</h1>
